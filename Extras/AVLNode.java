...
public class AVLNode{
	private Object _oData; //Stored object data
	...
	private int _iHeight; //Height of the subtree starting at this node
	
	//Constructors
	/**
	 * Make a lonely new node with no friends, with the specified data
	 */
	public AVLNode(Object oData){
		_nLeft=null;
		_oData=oData;
		_nRight=null;
		_nParent=null;
	...
	/**
	 * Make a lonely new node with no friends, with a parent, with the specified data
	 */
	public AVLNode(Object oData, AVLNode nParent){
		_nLeft=null;
		_oData=oData;
		_nRight=null;
		_nParent=nParent;
	...
	/**
	 * Sets the Left child
	 * @param	nLeft	The new left child
	 */
	 ...
	 * @param	nRight	The new right child
	 */
	 ...
	 */
	public void SetParent(AVLNode nParent){
		_nParent=nParent;
	}
	/**
	 * Sets the height
	...
	//Methods
	/**
	 * Calculates the balance factor based on the heights of the two child subtrees
	 */
