...
public class BTNode {
	...
	//Constructor
	//Make a lonely new node with no friends, with the specified data
	public BTNode(Object oData, BTNode nParent){
		_nLeft=null;
		_oData=oData;
		_nRight=null;
		_nParent=nParent;
	...
	//Constructor
	//Make a lonely new node with no friends, with the specified data
	public BTNode(Object oData, BTNode nParent, BTNode nLeft, BTNode nRight){
		_nLeft=nLeft;
		_oData=oData;
		_nRight=nRight;
		_nParent=nParent;
	...
	public void SetLeft(BTNode nLeft){
		_nLeft=nLeft;
	}
	public void SetRight(BTNode nRight){
		_nRight=nRight;
	}
	public void SetParent(BTNode nParent){
		_nParent=nParent;
	}
}
