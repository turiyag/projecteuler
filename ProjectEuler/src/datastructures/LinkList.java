...
public class LinkList {
	...
	public LinkList(final Object oElem) {
	...
	public void add(final Object oElem) {
		if (_len > 0) {
	...
	public void clear() {
		// Set the length to 0
		_len = 0;
		// Clear the head and tail, and let the garbage collector take care of
		// the rest
		_lnHead = null;
		_lnTail = null;
	}
	...
	public Object[] toArray() {
		...
		final Object[] oaRet = new Object[_len];
	...
	public String[] toStringArray() {
		// Define an array large enough to hold the entire list
		final String[] saRet = new String[_len];
		// Set lnNode to the first element
		ListNode lnNode = GetHead();
		// Loop through every node and copy every element to the array
		for (int i = 0; i < _len; i++) {
